...
export const ALPHABET_ONLY = /^[a-zA-Z\u0E01-\u0E39\u0E40-\u0E4C\s]+$/
...
export const WEIGHT_VALIDATION = /^(\b(?!0)\d{1,3}\b)+(\.\d{1,2})?$/
export const HEIGHT_VALIDATION = /^(\b(?!0)\d{2,3}\b)+(\.\d{1})?$/
...
// To check if an application from input form
export const IS_AFTER_FORM = /.*_after_form$/
